...
class Channel(Base):
    ...
    model_check_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    model_check_interval_minutes: Mapped[int] = mapped_column(Integer, default=10, nullable=False)
    balance_check_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
...
class ChannelSyncLink(Base):
    ...
    sub2api_priority: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
    sub2api_concurrency: Mapped[int] = mapped_column(Integer, default=10, nullable=False)
    newapi_groups: Mapped[str] = mapped_column(Text, default="default", nullable=False)
